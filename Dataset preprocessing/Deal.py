...
parser.add_argument("--src_path", type=str, default='./origin_datas', help="Dataset directory to be processed.")
parser.add_argument("--conservative", type=bool, default=False, help="The balance factor is countdown or half adjust.")
parser.add_argument("--augmentation_level", type=int, default=4, help="The strength of data augmentation.")
...
parser.add_argument("--is_partition", type=bool, default=False, help="Is the dataset partitioned.")
